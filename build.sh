...
if [ "$KVER" == "6.6" ]; then
  ...
  KERNEL_REPO="https://github.com/Peridot-Development/kernel_xiaomi_peridot"
...
CLANG_URL="https://github.com/XSans0/WeebX-Clang/releases/download/WeebX-Clang-20.0.0git-release/WeebX-Clang-20.0.0git.tar.gz"
